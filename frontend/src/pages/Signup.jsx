    ...
    <div className="min-h-screen grid-bg flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md animate-slide-up relative">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-1" style={{ fontFamily: 'Playfair Display, serif' }}>Create Account</h1>
        ...
        <div className="card">
          <form onSubmit={submit} className="space-y-5">
            <div>
              ...
              <input name="name" required className="input-field" placeholder="Jane Smith" value={form.name} onChange={handle} />
            </div>
            <div>
              <label className="label">Email address</label>
              <input name="email" type="email" required className="input-field" placeholder="you@example.com" value={form.email} onChange={handle} />
            </div>
            <div>
